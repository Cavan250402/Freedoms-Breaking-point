...
Background = pygame.display.set_mode((896 ,896))
Green = (45,198,14)
...
grid = [[None for i in range(0, 900, 64)] for j in range(0, 900, 64)]
...
while run:
    ...
    for event in pygame.event.get():
     ...
     #   if event.type == pygame.KEYDOWN:
      #      if event.key == pygame.K_LEFT:
       #         Background.blit(RedInfantry,(100, 300))

    Move(0,3)
# MAKE SURE EACH BOX IS TIMES BY 64 FOR BOTH WIDTH AND HEIGHT
