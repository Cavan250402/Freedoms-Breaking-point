...
def Move():
    if event.type == pygame.KEYDOWN:
        if event.key == pygame.K_LEFT:
            Background.blit(RedInfantry,(5, 5))
        if event.key == pygame.K_RIGHT:
            Background.blit(RedInfantry,(5, 3))
        if event.key == pygame.K_UP:
            Background.blit(RedInfantry,(3, 5))
        if event.key == pygame.K_DOWN:
            Background.blit(RedInfantry,(3, 1))
...
while run:
 ...
 #       if event.type == pygame.KEYDOWN:
     #       if event.key == pygame.K_LEFT:
            #    Background.blit(RedInfantry,(1, 3))
        Move()
